...
class TAIPAN:
    def __init__(self):
        ...
        self.head_up = pygame.image.load('Taipan/head_up.png').convert_alpha()
        self.head_down = pygame.image.load('Taipan/head_down.png').convert_alpha()
        self.head_right = pygame.image.load('Taipan/head_right.png').convert_alpha()
        self.head_left = pygame.image.load('Taipan/head_left.png').convert_alpha()
		
        self.tail_up = pygame.image.load('Taipan/tail_up.png').convert_alpha()
        self.tail_down = pygame.image.load('Taipan/tail_down.png').convert_alpha()
        self.tail_right = pygame.image.load('Taipan/tail_right.png').convert_alpha()
        self.tail_left = pygame.image.load('Taipan/tail_left.png').convert_alpha()

        self.body_vertical = pygame.image.load('Taipan/body_vertical.png').convert_alpha()
        self.body_horizontal = pygame.image.load('Taipan/body_horizontal.png').convert_alpha()

        self.body_tr = pygame.image.load('Taipan/body_tr.png').convert_alpha()
        self.body_tl = pygame.image.load('Taipan/body_tl.png').convert_alpha()
        self.body_br = pygame.image.load('Taipan/body_br.png').convert_alpha()
        self.body_bl = pygame.image.load('Taipan/body_bl.png').convert_alpha()

        self.train_sound = pygame.mixer.Sound('Audio/horn.wav')
...
class MAIN:
    ...
    def grass_background(self):
        NewTracks = pygame.image.load('Taipan/TaipanTracks.png').convert()
    ...
    def game_over(self):
        ...
        sample = pygame.mixer.music.load('Audio/GameOverMusic.wav')
...
track = pygame.image.load('Taipan/TaipanTracks.png').convert_alpha()
game_font = pygame.font.Font('assets/Pixeled.ttf', 25)
game_over_font = pygame.font.Font('assets/Pixeled.ttf', 84)
game_score_font = pygame.font.Font('assets/Pixeled.ttf', 44)
play_again_font = pygame.font.Font('assets/Pixeled.ttf', 30)
back_button_font = pygame.font.Font('assets/Pixeled.ttf', 23)
...
def TaipanGame():
    ...
    TaipanBGM = pygame.mixer.music.load('Audio/TaipanMusic.wav')
    pygame.mixer.music.play(-1, 0.0)
    GAMEBGM
...
class BULLET:
    def __init__(self):
        ...
        self.train_soundBM = pygame.mixer.Sound('Audio/horn.wav')
...
class MAINBM:
    ...
    def grass_backgroundBM(self):
       NewTracksBM = pygame.image.load('Bullet/BulletTracks.png').convert()
    ...
    def game_overBM(self):
        Game_over_imageBM = pygame.image.load('assets/GameOver.png').convert()
        score_text_2BM = str(len(self.bullet.bodyBM)-3)
        sampleBM = pygame.mixer.music.load('Audio/GameOverMusic.wav')
        pygame.mixer.music.play(-1, 0.0)
        GAMEBGM
...
trackBM = pygame.image.load('Bullet/BulletTracks.png').convert_alpha()
game_fontBM = pygame.font.Font('assets/Pixeled.ttf', 25)
game_over_fontBM = pygame.font.Font('assets/Pixeled.ttf', 84)
game_score_fontBM = pygame.font.Font('assets/Pixeled.ttf', 44)
play_again_fontBM = pygame.font.Font('assets/Pixeled.ttf', 30)
back_button_fontBM = pygame.font.Font('assets/Pixeled.ttf', 23)
...
def BulletGame():
    ...
    BulletBGM = pygame.mixer.music.load('Audio/BulletMusic.wav')
    pygame.mixer.music.play(-1, 0.0)
    GAMEBGM
...
class STEAM:
    def __init__(self):
        ...
        self.train_soundT = pygame.mixer.Sound('Audio/horn.wav')
...
class MAIN:
    ...
    def grass_backgroundT(self):
        NewTracksT = pygame.image.load('Steam/SteamTracks.png').convert()
    ...
    def game_overT(self):
        ...
        Game_over_imageT = pygame.image.load('assets/GameOver.png').convert()
        sampleT = pygame.mixer.music.load('Audio/GameOverMusic.wav')
        pygame.mixer.music.play(-1, 0.0)
        GAMEBGM
...
trackT = pygame.image.load('Steam/SteamTracks.png').convert_alpha()
game_fontT = pygame.font.Font('assets/Pixeled.ttf', 25)
game_over_fontT = pygame.font.Font('assets/Pixeled.ttf', 84)
game_score_fontT = pygame.font.Font('assets/Pixeled.ttf', 44)
play_again_fontT = pygame.font.Font('assets/Pixeled.ttf', 30)
...
def SteamGame():
    ...
    SteamBGM = pygame.mixer.music.load('Audio/SteamMusic.wav')
    pygame.mixer.music.play(-1, 0.0)
    GAMEBGM
...
GAMEBGM = pygame.mixer.music.set_volume(0.7)
#GAMEAUDIO = 
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if OPTIONS_BACK.checkForInput(OPTIONS_MOUSE_POS):
                    main_menu()
            if event.type == pygame.MOUSEBUTTONDOWN:
                if VOLUME_1.checkForInput(OPTIONS_MOUSE_POS):
                    GAMEBGM = pygame.mixer.music.set_volume(0.1)
            if event.type == pygame.MOUSEBUTTONDOWN:
                if VOLUME_2.checkForInput(OPTIONS_MOUSE_POS):
                    GAMEBGM = pygame.mixer.music.set_volume(0.2)
            if event.type == pygame.MOUSEBUTTONDOWN:
                if VOLUME_3.checkForInput(OPTIONS_MOUSE_POS):
                    GAMEBGM = pygame.mixer.music.set_volume(0.3)
            if event.type == pygame.MOUSEBUTTONDOWN:
                if VOLUME_4.checkForInput(OPTIONS_MOUSE_POS):
                    GAMEBGM = pygame.mixer.music.set_volume(0.4)
            if event.type == pygame.MOUSEBUTTONDOWN:
                if VOLUME_5.checkForInput(OPTIONS_MOUSE_POS):
                    GAMEBGM = pygame.mixer.music.set_volume(0.5)
            if event.type == pygame.MOUSEBUTTONDOWN:
                if VOLUME_6.checkForInput(OPTIONS_MOUSE_POS):
                    GAMEBGM = pygame.mixer.music.set_volume(0.6)
            if event.type == pygame.MOUSEBUTTONDOWN:
                if VOLUME_7.checkForInput(OPTIONS_MOUSE_POS):
                    GAMEBGM = pygame.mixer.music.set_volume(0.7)
            if event.type == pygame.MOUSEBUTTONDOWN:
                if VOLUME_8.checkForInput(OPTIONS_MOUSE_POS):
                    GAMEBGM = pygame.mixer.music.set_volume(0.8)
            if event.type == pygame.MOUSEBUTTONDOWN:
                if VOLUME_9.checkForInput(OPTIONS_MOUSE_POS):
                    GAMEBGM = pygame.mixer.music.set_volume(0.9)
            if event.type == pygame.MOUSEBUTTONDOWN:
                if VOLUME_10.checkForInput(OPTIONS_MOUSE_POS):
                    GAMEBGM = pygame.mixer.music.set_volume(1.0)
